function app_2(){
    ...
    var RADIO=50,      //radio en cm del ciclotron
        ...
        orgTray,
        //semiperiodo
        sPeriodo,      //   el valor introducido
        SemiPeriodo,      //el teorico
        ...
        bPoloMas=true, //sale del ciclotron
        bCorte=false, //deplazamiento del origen vertical org Y
        dOrgY=0.0, //puntos de corte
        x=0.0,
        y=0.0,
        //parametros del ciclotron
        indice=0,
...
//desplazamiento del origen tiende a cero para un numero grande de vueltas
            dOrgY+=(r-r1);
            r1=r;
...
//llega al diametro (parte inferior)
        if(angulo==360){
